...
export const Header = () => {
  ...
  return (
    <>
      <div
        className="relative flex h-[10%]  cursor-default items-center space-x-4  p-2 shadow-lg drop-shadow"
      ...
      >
        ...
        >
          <img className="h-9 w-9" src={botAvatar} alt="Bot Logo" />
        </div>
        <div className="w-full ">
          <div className="text-xl font-semibold antialiased">Chatbot</div>
          <p className="">Rasa Chatbot</p>
        </div>
        <motion.div
